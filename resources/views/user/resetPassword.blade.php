...
@section('content')
    <section class="login-clean" style="box-shadow: 0px 0px;">
        <form method="post" style="height: 326px;">
            ...
            <div class="mb-3"></div><input class="form-control" type="password" name="password" placeholder="Repeat Password"><button class="btn btn-primary d-block w-100" type="submit" style="background: #ff655b;font-size: 22px;">Reset</button>
        </form>
    </section>
@endsection