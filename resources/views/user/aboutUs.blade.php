    ...
    <section class="article-list">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col d-md-flex align-items-md-center"><img class="img-fluid" src="assets/img/star-sky.jpg"></div>
            </div>
            <div class="row" style="margin-top: 10px;">
                <div class="col-sm-12 col-md-5 d-md-flex align-items-md-center"><img class="img-fluid" src="assets/img/loft.jpg"></div>
                <div class="col">
