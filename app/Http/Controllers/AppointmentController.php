...
class AppointmentController extends Controller
{
    public function index()
    {
        $appointments = DB::table('appointments')
                        ...
                        -> select('appointments.*', 'users.name as user_name', 'users.email as user_email', 'staff.name as staff_name', 'clinics.name as clinic_name', 'health_services.ServiceName', 'time_slots.ServiceTime')
                        -> where('appointments.attend_date', '>=' ,date('Y-m-d'))
                        -> orderBy('appointments.attend_date')
