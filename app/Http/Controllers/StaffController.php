...
class StaffController extends Controller
{
    ...
    public function schedule()
    {
        $appointments = DB::table('appointments')
                        ...
                        -> select('appointments.*', 'users.name as user_name', 'users.id as user_id', 'clinics.name as clinic_name', 'staff.name as staff_name', 'health_services.ServiceName', 'time_slots.ServiceTime')
